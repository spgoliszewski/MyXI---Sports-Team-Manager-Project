  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Top Scorers</h1>
          <p className="text-gray-500 mt-1">All players ranked by goals scored</p>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-center py-3 px-4 font-semibold text-gray-700">G/M</th>
                ...
                <tbody>
                  {topScorers.map((player, index) => {
                    ...
                    <tr key={player.id} className="border-b hover:bg-accent">
                      ...
                      <td className="py-3 px-4 text-center">
                        <span className="text-gray-600">{player.stats.assists}</span>
                      </td>
                      <td className="py-3 px-4 text-center">
