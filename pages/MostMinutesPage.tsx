...
export default function MostMinutesPage() {
  ...
  const topMinutes = useMemo(() => {
    return players.sort((a, b) => b.stats.minutesPlayed - a.stats.minutesPlayed);
  }, [players]);
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Most Minutes Played</h1>
          <p className="text-gray-500 mt-1">All players ranked by total minutes</p>
        </div>
